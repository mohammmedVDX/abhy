...
def ipinfo():
       ...
       print ("\033[1;32m\007\n")
       os.system("figlet Cup Bomb | lolcat")
       slowprint("\033[1;36m =====================================")
       slowprint("\033[1;33m|                                     |")
       slowprint("\033[1;36m =====================================")
       ...
       print (" ")
       slowprint("\033[1;36m =====================================")
       slowprint("\033[1;33m|   Coded By mohmmdxzx23 and moha0338 |")
       slowprint("\033[1;36m =====================================")
       slowprint("\033[1;91m|   discord moha0338 and mohmmdxzx23 |")
       slowprint("\033[1;36m =====================================")
       print (" ")
       slowprint("\033[1;91mPress\033[1;36m ENTER\033[1;91m To Continue")
       print (" ")
       vpp = input("\033[1;33m[+] Cup Bomb | mohmmdxzx23 >>\033[1;32m")
       if vpp == " ":
                os.system("clear")
                return main()
...
def ext():
      slowprint ("\033[1;36m ==============================================")
      slowprint ("\033[1;33m|      Thanks For Using Cub bomb         |")
      slowprint ("\033[1;36m ==============================================")
      time.sleep(1)
      exit()
...
def main():
      os.system("clear")
      print("\033[1;36m")
      os.system("figlet Cup Bomb | mohmmdxzx23")
      slowprint(" ")
